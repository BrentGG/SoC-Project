...
namespace eval ::optrace {
  variable script "C:/SoC_Projecten/ToF_Sensor/ToF_Sensor.runs/impl_1/design_1_wrapper.tcl"
...
set rc [catch {
  ...
  open_checkpoint C:/SoC_Projecten/ToF_Sensor/ToF_Sensor.runs/impl_1/design_1_wrapper.dcp
